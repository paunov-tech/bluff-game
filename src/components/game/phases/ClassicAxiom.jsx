...
//
// API: GET /api/solo-rounds?phase=first&userId=… returns 6 rounds at
// difficulty [1,1,2,2,3,3]. We slice rounds[2..5) → difficulty [2,2,3] for
// a medium-difficulty run after the warm-up.
//
// Drama elements (sabotage, pit-fall, community pulse) are deliberately
// NOT here in step 2 — they live in App.jsx Climb state and need a careful
// extraction. Step 3 will lift them in.
